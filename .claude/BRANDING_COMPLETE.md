...
### Color Scheme
```css
--nepal-police-blue: #003893   /* Primary brand color */
--accent-blue: #4F6EBD          /* Tech accent */
--dark-bg: #0A0E1A              /* Command center aesthetic */
--text-primary: #E8EAF0         /* High contrast text */
--critical: #FF4D4D             /* Alert red */
