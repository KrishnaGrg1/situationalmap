    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M14 9C12 9 10.5 10.5 10.5 13C10.5 15.5 13.5 18 14 18.5C14.5 18 17.5 15.5 17.5 13C17.5 10.5 16 9 14 9Z" fill="#3B82F6" opacity="0.8" />
        </svg>
        <div className="flex flex-col leading-none">
          <span className="text-sm font-bold text-[#E8EAF0] font-['Syne']">SM</span>
          <span className="text-xs font-extrabold text-[#3B82F6] tracking-wider font-['Syne']">NP</span>
        </div>
      </div>
    );
  }
    ...
    <div className={`flex items-center gap-2.5 ${className}`}>
      ...
      <div className="flex flex-col leading-tight">
        <div className="text-base font-bold text-[#E8EAF0] tracking-tight font-['Syne']">
          SituationalMap <span className="text-[#3B82F6] font-extrabold tracking-wide">NP</span>
        </div>
