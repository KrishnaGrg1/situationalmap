      ...
      <div className="grid grid-cols-4 gap-3">
        <Card>
          <CardHeader className="pb-3">
            ...
            <CardTitle className="text-2xl text-blue-500">{totalOfficers}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription className="text-xs uppercase tracking-wide">Deployed</CardDescription>
            <CardTitle className="text-2xl text-green-500">{deployedOfficers}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription className="text-xs uppercase tracking-wide">Vehicles</CardDescription>
            <CardTitle className="text-2xl text-orange-500">{vehicleCount}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription className="text-xs uppercase tracking-wide">Available</CardDescription>
        ...
        <Card>
          <CardContent className="p-0">
            {resources.map((resource, index) => (
              ...
              >
                <div className={cn('size-9 rounded-md flex items-center justify-center flex-shrink-0', getResourceIcon(resource.status))}>
                ...
                <span className={cn('text-xs px-2 py-1 rounded border font-mono whitespace-nowrap', getResourceStatusColor(resource.status))}>
